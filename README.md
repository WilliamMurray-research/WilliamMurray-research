Firstly, yes, I make extensive use of large language models; I am one person who is trying to do hard things, it really is the only way.  That said, I am fastidious about analysing my use of these system, and spend considerable time considering how I can improve my systems and processes. My views here are deeply coloured by my previous professional experience and studies (most notably cognitive linguistics and neuroscience, focusing on language acquisition and comprehension with respect to the complexity of legal drafting). 
